...
```{r}
boxplot(ventas$CONSECUTIVO, col = terrain.colors(4), main="Tabla Ventas - Producto")
```

```{r}
hist(ventas$USUARIO, xlab = "Usuario", ylab = "Frecuencia", freq = F, main = "Histograma de Usuario ", col = "steelblue")
